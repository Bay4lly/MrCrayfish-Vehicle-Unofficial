...
public class VehiclePropertiesGen extends VehiclePropertiesProvider
{
    ...
    protected void registerProperties()
    {
        this.add(ModEntities.ALUMINUM_BOAT.get(), VehicleProperties.builder()
                ...
                .setFuelPortPosition(PartPosition.create(-14.5, 16.0, -14.0, 0.0, -90.0, 0.0, 0.7))
        ...
        this.add(ModEntities.QUAD_BIKE.get(), VehicleProperties.builder()
                .setAxleOffset(-0.5F)
                .setBodyPosition(PartPosition.create(1.1))
                  .setEnginePosition(PartPosition.create(0.0, 1.0, -1.0, 0.0, 180.0, 0.0, 0.5))
                .setFuelPortPosition(PartPosition.create(0.0, 6.4876, 7.5, -90.0, 0.0, 0.0, 0.6))
                .setKeyPortPosition(PartPosition.create(-5.0, 4.5, 6.5, -45.0, 0.0, 0.0, 0.5))
                .setDisplayPosition(PartPosition.create(1.5))
                .setHeldOffset(4.0, 3.5, 0.0)
        ...
        this.add(ModEntities.COMPACT_HELICOPTER.get(), VehicleProperties.builder()
                .setBodyPosition(PartPosition.create(1.0))
                // adjusted fuel port to better match model fuel door (tweak if still misaligned)
                .setFuelPortPosition(PartPosition.create(-13.2, 14.0, -12.5, 0.0, -90.0, 0.0, 0.7))
                .setDisplayPosition(PartPosition.create(1.0))
