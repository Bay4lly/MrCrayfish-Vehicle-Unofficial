...
extends AbstractContainerScreen<FluidExtractorContainer> {
    private static final ResourceLocation GUI = ResourceLocation.parse((String)"vehicle:textures/gui/fluid_extractor.png");
